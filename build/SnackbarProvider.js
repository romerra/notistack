...
var SnackbarProvider = /*#__PURE__*/function (_Component) {
  ...
  function SnackbarProvider(props) {
    ...
    _defineProperty(_assertThisInitialized(_this), "enqueueSnackbar", function (message) {
      ...
      var snack = _objectSpread(_objectSpread({
        key: id
      }, options), {}, {
        message: message,
        open: true,
      ...
      _this.setState(function (state) {
        ...
        return _this.handleDisplaySnack(_objectSpread(_objectSpread({}, state), {}, {
      ...
      _this.setState(function (_ref3) {
        ...
        return {
          snacks: snacks.map(function (item) {
            ...
            return item.entered ? _objectSpread(_objectSpread({}, item), {}, {
              open: false
    ...
    _defineProperty(_assertThisInitialized(_this), "handleExitedSnack", function (event, key) {
      _this.setState(function (state) {
        var newState = _this.processQueue(_objectSpread(_objectSpread({}, state), {}, {
  ...
  _createClass(SnackbarProvider, [{
    ...
    value: function render() {
      ...
      var categ = this.state.snacks.reduce(function (acc, current) {
        ...
        return _objectSpread(_objectSpread({}, acc), {}, _defineProperty({}, category, [].concat(_toConsumableArray(existingOfCategory), [current])));
      }, {});

      var iconVariant = _objectSpread(_objectSpread({}, _defaultIconVariants["default"]), this.props.iconVariant);
      ...
      var snackbars = Object.entries(categ).map(function (_ref4) {
        ...
        return /*#__PURE__*/_react["default"].createElement(_SnackbarContainer["default"], {
          key: origin,
          dense: dense,
          anchorOrigin: snacks[0].anchorOrigin,
          className: classes["containerAnchorOrigin".concat(origin)]
        }, snacks.map(function (snack) {
          return /*#__PURE__*/_react["default"].createElement(_SnackbarItem["default"], _extends({}, props, {
            key: snack.key,
            dense: dense,
            snack: snack,
      ...
      return /*#__PURE__*/_react["default"].createElement(_SnackbarContext["default"].Provider, {
        value: contextValue
      }, children, domRoot ? /*#__PURE__*/(0, _reactDom.createPortal)(snackbars, domRoot) : snackbars);
    }
  }, {
    key: "maxSnack",
    get: function get() {
